		...
		<div id="Member_Ratings">
			<div class="d_Confirm_Order_style">
				...
				<c:if test="${user_type == 'user'}"><div class="border clearfix">
					<span class="l_f"> <a
						href="${pageContext.request.contextPath}/Chur/initUtil.do"
						class="btn btn-warning"><i class="icon-plus"></i>添加出入信息</a> </span>
				</div></c:if>
				<c:if test="${user_type == 'admin'}"><div class="border clearfix">
					<span class="l_f"> <a
						href="${pageContext.request.contextPath}/Chur/initUtil.do"
						class="btn btn-warning"><i class="icon-plus"></i>添加出入信息</a> <a
				...
				<div class="table_menu_list">
					<form
						action="${pageContext.request.contextPath}/Chur/deleteManyUtil.do"
								...
								<c:forEach var="tmp" items="${pageModel.list}">
									<tr>
										...
										<td class="td-manage"><c:if test="${user_type == 'admin'}"><a title="编辑" class="btn btn-xs btn-info"
											href="${pageContext.request.contextPath}/Chur/selectUtil.do?id=${tmp.id }"><i
												class="icon-edit bigger-120"></i> </a> <a title="删除"
											href="javascript:;"
											onclick="member_del('${pageContext.request.contextPath}/Chur/deleteUtil.do?id=${tmp.id }')"
