...
<body>
	<form
		action="${pageContext.request.contextPath}/TouSu/saveOrUpdateObject.do"
		method="post">
				...
				<div class="add_content" id="form-article-add">
					<ul>
						<div class="clearfix cl">
							<div class="Add_p_s">
								<label class="form-label col-2">投诉人：</label>
						...
						<div class="clearfix cl">
							...
							<div class="formControls col-10" style="width: 400px;">
								<input type="text" class="input-text" value="${util.s_0 }"
									placeholder="投诉标题" id="" name="s_0">
							</div>
							<label class="form-label col-2">投诉日期：</label>
							<div class="formControls col-10" style="width: 400px;">
								<input type="text" onClick="WdatePicker();" id="datemin"
									class="input-text Wdate" style="width: 186px;"
									value="${util.s_1 }" placeholder="投诉日期" id="" name="s_1">
							</div>
						</div>
						<div class="clearfix cl">
							<label class="form-label col-2">投诉类型：</label>
							<div class="formControls col-10" style="width: 400px;">
								<input type="text" class="input-text" value="${util.s_2 }"
									placeholder="投诉类型" id="" name="s_2">
							</div>
							<label class="form-label col-2">投诉内容：</label>
							<div class="formControls col-10" style="width: 400px;">
								<input type="text" class="input-text" value="${util.s_3 }"
									placeholder="投诉内容" id="" name="s_3">
							</div>
						</div>
						<div class="clearfix cl">
							<label class="form-label col-2">投诉说明：</label>
							<div class="formControls col-10" style="width: 400px;">
								<input type="text" class="input-text" value="${util.s_4 }"
									placeholder="投诉说明" id="" name="s_4">
							</div>
							<label class="form-label col-2">投诉建议：</label>
							<div class="formControls col-10" style="width: 400px;">
								<input type="text" class="input-text" value="${util.s_5 }"
									placeholder="投诉建议" id="" name="s_5">
							</div>
						</div>
						<div class="clearfix cl">
							<label class="form-label col-2">投诉状态：</label>
							<div class="formControls col-10" style="width: 400px;">
								<c:if test="${util.id == null }">
									<select class="form-control " style="width: 186px;" name="s_6">
										<option <c:if test="${util.s_6 == '未处理'}">selected</c:if>
											value="未处理">未处理</option>
										<c:if test="${user_type == 'admin' }">
											<option <c:if test="${util.s_6 == '已处理'}">selected</c:if>
