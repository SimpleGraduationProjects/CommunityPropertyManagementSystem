		...
		<div id="Member_Ratings">
			<div class="d_Confirm_Order_style">
				...
				<c:if test="${user_type == 'admin'}"><div class="border clearfix">
					<span class="l_f"> <a
						href="${pageContext.request.contextPath}/Kuaidi/initUtil.do"
						class="btn btn-warning"><i class="icon-plus"></i>添加快递查询</a> <a
				...
				<div class="table_menu_list">
					<form
						action="${pageContext.request.contextPath}/Kuaidi/deleteManyUtil.do"
								...
								<c:forEach var="tmp" items="${pageModel.list}">
									<tr>
										...
										<td class="td-manage"><c:if test="${user_type == 'admin'}"><a title="编辑" class="btn btn-xs btn-info"
											href="${pageContext.request.contextPath}/Kuaidi/selectUtil.do?id=${tmp.id }"><i
												class="icon-edit bigger-120"></i> </a> <a title="删除"
											href="javascript:;"
											onclick="member_del('${pageContext.request.contextPath}/Kuaidi/deleteUtil.do?id=${tmp.id }')"
