						...
						<form class="registerform" method="post"
							...
							<table width="100%">
								...
								<tr>
									...
									<td style="width: 210px;"><input type="password"
										name="s_1" class="inputxt" plugin="passwordStrength"
								...
								<tr class="yanzheng clearFloat">
									...
									<td class="yanimg"><input type="text" class="inputxta"
										name="code"><img id="codeimg" src="imageServlet"
										onClick="flushCode()" /> <a onClick="flushCode()"
										class="yana">看不清？换一张</a></td>
								</tr>
